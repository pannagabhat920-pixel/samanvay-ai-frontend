...
>(({ className, ...props }, ref) => (
  <AvatarPrimitive.Fallback ref={ref} className={cn("flex h-full w-full items-center justify-center rounded-full bg-surface3 text-[10px] font-semibold text-text-secondary", className)} {...props} />
));
